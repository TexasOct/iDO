...
from Cython.Build import (  # pyright: ignore[reportMissingTypeStubs, reportMissingImports]
    cythonize,  # pyright: ignore[reportUnknownVariableType, reportMissingImports]
)
from setuptools import setup  # pyright: ignore[reportMissingModuleSource]
from setuptools.command.install import install as _install  # pyright: ignore[reportMissingModuleSource]
from setuptools_rust import RustExtension  # pyright: ignore[reportMissingImports]
...
INCLUDE_FILE_PATTERNS = ("tauri_app/**/*.py",)
