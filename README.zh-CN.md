...
> 本地优先的 AI 桌面助手，捕获你的活动流，使用 LLM 总结上下文，并推荐下一步任务——所有处理都在你的设备上完成。
...
- **🌍 可扩展**：插件化 Agent 系统、自定义 LLM 提供商、模块化设计
...
| 工具    | 版本   | 安装方式                                                      |
| ------- | ------ | ------------------------------------------------------------- |
| Node.js | ≥ 20.x | [nodejs.org](https://nodejs.org/) 或 `nvm install 20`        |
| pnpm    | ≥ 9.x  | `npm install -g pnpm`                                         |
| Python  | ≥ 3.14 | [python.org](https://www.python.org/) 或 `pyenv install 3.14` |
| uv      | 最新   | `curl -LsSf https://astral.sh/uv/install.sh \| sh`            |
| Rust    | 最新   | `curl --proto '=https' --tlsv1.2 -sSf https://sh.rustup.rs \| sh` |
...
- **CLAUDE.md**：[CLAUDE.md](CLAUDE.md) - LLM 友好的项目指南
